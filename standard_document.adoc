:Title: Volume 2: OGC CDB Core Model and Physical Structure Annexes (Best Practice)
:titletext: Volume 2: OGC CDB Core Model and Physical Structure Annexes (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document:  http://www.opengis.net/doc/BP/CDB-core-annexes/1.3
|Internal reference number of this OGC(R) document:        16-005r5
|Version: 1.3
