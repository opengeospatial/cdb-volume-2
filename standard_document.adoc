:Title: OGC CDB Core Model and Physical Structure Annexes (Best Practice)
:titletext: OGC CDB Core Model and Physical Structure Annexes (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
This document defines an OGC Best Practices on a particular technology or approach related to an OGC
standard. This document is *not* an OGC Standard and may not be referred to as an OGC Standard. It is
subject to change without notice. However, this document is an *official* position of the OGC membership
on this particular technology topic.
...
include::annex-j.adoc[]

include::annex-m.adoc[]

include::annex-o.adoc[]

include::annex-q.adoc[]

include::annex-r.adoc[]

include::annex-s.adoc[]
